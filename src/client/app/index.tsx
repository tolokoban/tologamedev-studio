...
const Page2 = React.lazy(() => import("./tools/texture-paint/page"))
...
export default function App({ lang }: { lang?: string }) {
    ...
    return (
        <Route path="/" Page={pg0} Layout={ly0} fallback={fb} context={context}>
            <Route path="/tools" fallback={fb} context={context}>
                <Route path="/tools/texture-paint" Page={pg2} fallback={fb} context={context}/>
            </Route>
        </Route>
    )
}
